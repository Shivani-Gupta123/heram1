                                ...
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        <div class="btn-group float-right">
                                             <a href="add_slider.php" class="btn btn-primary mb-3">Add New</a>
                                        </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <tr>
                                                ...
                                                <td><?php echo $key['short_text'];?></td>
                                                      ...
                                                      <td>
                                                          <a href="edit_slider.php?id=<?php echo $key['id']?>" class="btn btn-primary waves-effect waves-light"><i class="fa fa-edit" aria-hidden="true"></i>
                                    
                                                        </a>
                                                      

                                                 <!-- <a href="app/slider_crud.php?id=<?php echo $key['id']?>" class="btn btn-danger"><i class="fa fa-trash-alt" aria-hidden="true"></i></a> -->

                                                <a href="app/slider_crud.php?id=<?php echo $key['id']?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">
