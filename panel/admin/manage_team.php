            ...
            <div class="col-sm-12">
                <div class="page-title-box">
                    <div class="btn-group float-right">
                        <a href="add_team.php" class="btn btn-primary mb-3">Add New</a>
                    </div>
                    <h4 class="page-title">View Director</h4>
                </div>
            </div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($record as $key) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit_team.php?id=<?php echo $key['id'] ?>" class="btn btn-primary waves-effect waves-light"><i class="fa fa-edit" aria-hidden="true"></i>

                                                </a>


                                                <a href="app/team_crud.php?id=<?php echo $key['id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-alt" aria-hidden="true"></i></a>
