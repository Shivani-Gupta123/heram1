                                    ...
                                    foreach ($record as $key) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?') && delForm(event, <?php echo $key['id'] ?>, 'app/product.php')"><i class="fa fa-trash-alt" aria-hidden="true"></i></a>
