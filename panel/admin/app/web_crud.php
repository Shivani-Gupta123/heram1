...
try {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($_FILES['photo1']['tmp_name'] != '') {
            ...
            // Generate a new unique file nameupda
...
if (isset($_POST['update'])) {
        ...
        $stmt = $conn->prepare("UPDATE `manage_web` SET `title` = :title, `photo1` = :img, `photos` = :img1, `sitekey` = :sitekey, `secretkey` = :secretkey, `location` = :location, `contact` = :contact, `email` = :email WHERE id = :id");
    ...
    if (isset($_POST['update3'])) {
        ...
        $stmt = $conn->prepare("UPDATE `emailsetting` SET `smtp_server`='" . $_POST['smtp_server'] . "',`smtp_username`='" . $_POST['smtp_username'] . "',`smtp_password`='" . $_POST['smtp_password'] . "',`stmp_port`='" . $_POST['stmp_port'] . "',`smtp_type`='" . $_POST['smtp_type'] . "',`email`='" . $_POST['email'] . "' WHERE id='" . $_POST['id'] . "' ");
    ...
    if (isset($_POST['update6'])) {
        ...
        $stmt->bindParam($img1, $img2, $img3, $img4, $img5, $img6, $img7, $img8, $img9, $img10, $img11, $img12, $img13, $_POST['id']);
        $stmt->execute();
