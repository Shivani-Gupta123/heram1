            ...
            <div class="col-sm-12">
                <div class="page-title-box">
                    <div class="btn-group float-right">
                        <a href="add_category.php" class="btn btn-primary mb-3">Add New</a>
                    </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" enctype="multipart/form-data">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $stmt = $conn->prepare("SELECT * FROM `category` WHERE delete_status='0' ");
                                    $stmt->execute();
                                    ...
                                    foreach ($record as $key) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit_category.php?id=<?php echo $key['id'] ?>" class="btn btn-primary waves-effect waves-light"><i class="fa fa-edit" aria-hidden="true"></i>

                                                </a>
                                                <a href="app/category.php?id=<?php echo $key['id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">
