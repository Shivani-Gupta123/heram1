                        ...
                        <div class="table-responsive">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" enctype="multipart/form-data">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $stmt = $conn->prepare("SELECT * FROM `career_info` WHERE delete_status='0' ORDER BY created_date DESC ");
                                    $stmt->execute();
                                    ...
                                    foreach ($record as $key) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td> <a href="../assets/files/<?php echo $key['resume']; ?>" target="_blank"><?php echo $key['resume']; ?></a></td>
